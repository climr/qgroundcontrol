...
Item {
    ...
    Row {
        ...
        QGCLabel {
            ...
            text: qsTr("Amarok Vehicle Specific Parameters:")
        }
...
*/
    ...
    QGCFlickable {
        ...
        visible:            true//!_searchFilter && !controller.showModifiedOnly
            ...
            Repeater {
                ...
                Column {
                    ...
                    SectionHeader {
                        ...
                        anchors.left:   parent.left
                        anchors.right:  parent.right
                        text:           controller.currentCategory
    ...
    QGCListView {
        ...
        anchors.left:       groupScroll.right//parent.left //(_searchFilter || controller.showModifiedOnly) ? parent.left : groupScroll.right
        anchors.right:      parent.right
        anchors.top:        header.bottom
        anchors.bottom:     parent.bottom
